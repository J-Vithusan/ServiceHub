  ...
  if (loading || isLoading) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-20 flex flex-col items-center justify-center">
        ...
        <p className="text-slate-600 dark:text-slate-400 text-sm font-medium">Loading your profile...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen py-10 md:py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Profile Card Header */}
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#0f171a] border border-slate-200/90 dark:border-slate-800/80 shadow-xs flex flex-col sm:flex-row items-center gap-6">
          <div className="relative">
            <div className="h-20 w-20 rounded-2xl bg-linear-to-tr from-teal-700 to-teal-500 flex items-center justify-center text-white text-2xl font-black overflow-hidden ring-4 ring-slate-100 dark:ring-slate-800 shadow-md">
              {avatarUrl ? (
          ...
          <div className="space-y-1.5 text-center sm:text-left flex-1">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
              ...
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-teal-50 text-teal-800 border border-teal-200 dark:bg-teal-950/60 dark:text-teal-300 dark:border-teal-800">
                {profile.role}
              </span>
            </div>
          ...
          <div className="text-center sm:text-right px-4 py-2 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/90 dark:border-slate-700/60">
            <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold block">Total Bookings</span>
        ...
        {/* Profile Edit Form */}
        <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#0f171a] border border-slate-200/90 dark:border-slate-800/80 shadow-xs space-y-6">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Update Contact Information</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled
                    value={profile.email}
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 text-sm text-slate-500 dark:text-slate-400 cursor-not-allowed font-medium"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <Image className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400 dark:text-slate-500" />
                  <input
                    type="url"
            ...
            <div className="pt-2 flex justify-end">
              <button
                type="submit"
                disabled={saving}
                className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-wider text-white bg-teal-700 hover:bg-teal-800 dark:bg-teal-600 dark:hover:bg-teal-500 shadow-sm shadow-teal-700/20 transition-all hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 cursor-pointer"
                id="save-profile-btn"
              >
