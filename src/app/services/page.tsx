...
function ServicesContent() {
  ...
  return (
    <div className="min-h-screen py-12 md:py-20 bg-background text-foreground transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Page Header */}
        <div className="max-w-3xl mb-12 space-y-3">
          <div className="flex items-center gap-3">
            <span className="mono-index text-teal-700 dark:text-teal-400 font-semibold tracking-widest">
              01 // INDEXED SPECIFICATIONS
            </span>
            <span className="h-px w-10 bg-border" />
            <span className="mono-index text-muted-foreground hidden sm:inline">
              LIVE DISPATCH INVENTORY
            </span>
          </div>
          <h1 className="editorial-title text-4xl sm:text-5xl lg:text-6xl font-black text-foreground tracking-[-0.03em] leading-tight">
            Explore All Services
          </h1>
          <p className="text-base text-muted-foreground font-normal leading-relaxed pt-1">
            Browse through our verified professional catalog. Filter by discipline, check live availability,
            and book with guaranteed transparent flat rates.
          </p>
        </div>

        {/* Filter & Search Bar */}
        <div className="p-4 sm:p-5 rounded-2xl bg-card border border-border mb-10 space-y-4 shadow-xs transition-all">
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-secondary/60 border border-border text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500/20 transition"
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <select
                ...
                className="w-full md:w-48 py-2.5 px-3 rounded-xl bg-secondary/60 border border-border text-sm text-foreground focus:outline-none focus:border-teal-500 cursor-pointer transition"
                id="sort-select"
              >
