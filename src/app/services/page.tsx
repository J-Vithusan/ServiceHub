    ...
    <div className="min-h-screen py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-10">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-xs font-bold border border-blue-500/20 mb-3">
          ...
          <p className="text-sm text-slate-400 mt-2">
            Browse through our certified service catalog. Select a specialist, check availability,
            and book instantly with transparent rates.
          </p>
        </div>

        {/* Filter & Search Bar */}
        <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-xl mb-8 space-y-4">
          <div className="flex flex-col md:flex-row items-center gap-3">
            ...
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-800/80 border border-slate-700/80 text-sm text-white placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
            ...
            <div className="flex items-center gap-2 w-full md:w-auto">
              ...
              <select
                ...
                className="w-full md:w-48 py-2.5 px-3 rounded-xl bg-slate-800/80 border border-slate-700/80 text-sm text-white focus:outline-none focus:border-blue-500 transition cursor-pointer"
                id="sort-select"
              >
        ...
        {loading || isPending ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="rounded-2xl bg-slate-900 border border-slate-800 p-4 space-y-4 animate-pulse"
              >
    ...
    <Suspense
      fallback={
        <div className="max-w-7xl mx-auto px-4 py-20 flex flex-col items-center justify-center">
          ...
          <p className="text-slate-400 text-sm">Loading services catalog...</p>
        </div>
      }
    >
      <ServicesContent />
